"""
This script generates job scripts to run "qiskit_varqite_wrapper.py" on
multiple computing nodes on a cluster.
The parameters for "qiskit_varqite_wrapper.py" are specified in the
...
"""
Specifying parameter values for "qiskit_varqite_wrapper.py"
"""
...
for params in set_of_params:
    ...
    with open(job_file, "w") as fh:
        ...
        fh.writelines("{ time python " +
                        ...
                        "--num_cpus %s ")
                        % (params + (CPUs,)) +
                        (" ; } 2> logs/time_qiskit_varqite_L%s_g%s_time%s_%s_"
